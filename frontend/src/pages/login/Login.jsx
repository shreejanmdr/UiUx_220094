...
//           <Box className="social-login-container" display="flex" justifyContent="center" gap={2}>
//             <Button
...
//             Don’t have an account? <a href="/register" style={{ textDecoration: "none", color: "#1976d2" }}>Sign Up</a>
//           </Typography>
//         </Box>
//         <Box
...
//           />
//           <Typography mt={2}>
//             Hey there, please login to your account to continue Estate Ease! Always remember us if you're finding a home.
//           </Typography>
//         </Box>
//       </Paper>
//     </Box>
