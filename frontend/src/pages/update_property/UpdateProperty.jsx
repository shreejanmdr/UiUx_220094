...
const UpdateProperty = () => {
    ...
    useEffect(() => {
        getSingleProperty(id).then((res) => {
            ...
            setPropertyDescription(res.data.property.propertyDescription)
            ...
            <div className='mt-3 d-flex flex-column align-items-center'>
                ...
                <div className='d-flex gap-3'>
                    <form action="">
                        ...
                        <label className='mt-2'>Property Description</label>
                        <textarea value={propertyDescription} onChange={(e) => setPropertyDescription(e.target.value)} className='form-control' rows="5" placeholder='Enter property description'></textarea>

                        <label className='mt-2'>Choose Property Image</label>
                        <input onChange={handleImage} type="file" className='form-control' />

                        <button onClick={handleUpdate} className="btn btn-secondary w-100 mt-2" style={{ backgroundColor: '#083775', borderColor: '#083775' }} >Save Changes</button>

                    </form>
                    <div className='image section'>
                        <h6>Previewing Old Image</h6>
                        <img height={'150px'} width={'300px'} className='image-fluid-rounded-4 object-fit-cover' src={`http://localhost:5000/property/${oldImage}`}></img>
