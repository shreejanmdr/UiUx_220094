...
const createProperty = async (req, res) => {
    ...
    //Validation
    if (!propertyTitle || !propertyPrice || !propertyLocation || !propertyCategory || !propertyDescription) {
...
const updateProperty = async (req, res) => {
    ...
    try {
        ...
        if (!propertyTitle || !propertyPrice || !propertyCategory || !propertyLocation || !propertyDescription) {
            return res.status(400).json({
                "success": false,
                "message": "Please enter all fields"
            })
